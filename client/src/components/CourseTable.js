...
class CourseTable extends Component {
    ...
    filterCourses(e) {
        ...
        this.courseFilter = this.state.curCourses.filter((course) =>
            course.courseName.includes(e, 0)
        );
        ...
        return (
            <div style={{ height: 600, width: "100%", marginBottom: 100 }}>
                ...
                <SearchBar
                    ...
                    onChange={(newValue) => this.filterCourses(newValue)}
                />
                <DataGrid
                    rows={this.courseFilter}
                    columns={columns}
                    pageSize={10}
                    checkboxSelection
                />
